...
# ---------------------------------------------------------------------------
# DocType Events — hooks for Sales Invoice
# ---------------------------------------------------------------------------
doc_events = {
    "Sales Invoice": {
        "before_insert": [
            "erpnext_pos_extensions.events.sales_invoice.before_insert"
        ],
    }
}

# ---------------------------------------------------------------------------
# DocType extensions — custom fields to add
# ---------------------------------------------------------------------------
fixtures = [
    "Custom Field",
    "Custom DocPerm",
